...
from django.conf.urls.i18n import i18n_patterns  # <-- added for language support

urlpatterns = [
    # If you want to allow switching language via POST, this is required
    path('i18n/', include('django.conf.urls.i18n')),
]

# Wrap your normal URLs inside i18n_patterns
